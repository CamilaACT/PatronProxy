...
export class BillingAPIService {
    ...
    protected basePath = 'http://localhost:7080/';
    ...
    public listUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<InvoiceResponse>>('get',`${this.basePath}/billing`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postUsingPOST(body: InvoiceRequest, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public postUsingPOST(body: InvoiceRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public postUsingPOST(body: InvoiceRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public postUsingPOST(body: InvoiceRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling postUsingPOST.');
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/billing`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public putUsingPUT(body: InvoiceRequest, id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling putUsingPUT.');
        }
